package com.ocypode.volley.request;
...
public class RequestHelper {
	...
	public static ErrorListener createErrorResponseListener(final Handler<?> handler) {
		return new ErrorListener() {
			...
			public void onErrorResponse(VolleyError error) {
				...
				handler.onFail(new VolleyError(VolleyErrorHelper.getMessage(error, null), error)); //TODO: inject context here
			}
		};
	}
	...
	public static Map<String, String> getHeaders() {
		...
		headers.put("Client-ID", "dc4023afe9002345");
		headers.put("FacebookToken", "LL2CEdEose0cBAE2DgkDXwGgwTZA7CFzVZA6j83GMZCrNKyZA4g2EhzhOswbmoZCcRGRobpsawBbfWNmovHUWIuEgkzFPnECVokSHFP8VeGxbxIUZAxOD21BAkB0SeLnQQKXhqomAutrGS1pNn9Mg77DweZCEKwC6q228ZAP0XimQ3uanRJvnO9xhebqsFoQSiUnEOBr85ZCsEbwZDZD");
		headers.put("Token", "fashga12812198219821982");
		return headers;
	}
}
